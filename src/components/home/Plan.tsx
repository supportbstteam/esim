        ...
        {featured?.slice(0, 5).map((plan) => (
          ...
          >
            <div className="px-[24px] py-[18px] flex flex-col min-[700px]:flex-row min-[700px]:items-center justify-center  min-[700px]:justify-between gap-4">
              {/* Country + Flag */}
              <div className="flex items-center gap-3 min-[900px]:w-[260px] justify-center">
                <Flag
                  countryName={plan?.country?.name}
                  size={36}
                  className="h-[36px] w-[36px]"
                />
                <p className="text-base min-[700px]:text-lg text-[#1A0F33] font-[700]">{plan?.country?.name}</p>
              </div>
              ...
              {/* Price */}
              <div className="text-[16px] w-[90px] flex items-center justify-center bg-[#F3F5F7] rounded-full px-4  py-1 leading-6.4 font-bold max-md:mx-auto">${plan.price}</div>
              ...
              <div>
                <button
                  ...
                  className="cursor-pointer w-full min-[700px]:w-auto px-6 min-[700px]:px-6 py-[11px] text-sm min-[700px]:text-base bg-[#3BC852] text-white rounded-full hover:bg-green-600 transition leading-[21px]"
                >
                  Add to Cart
                </button>
              </div>
