...
export const EasyStep = () => {
  return (
    <section className="px-6 md:px-[10%] py-12 bg-white container mb-25 ">
      {/* Heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Step 1 */}
        <div className="bg-[#F3F5F7] p-6 rounded-2xl shadow-sm">
          <h2 className="text-lg font-bold mb-4 bg-white rounded-4xl px-4 py-3 w-fit">01</h2>
          <h3 className="h4 mb-2">Pick Your Plan</h3>
          ...
          <div className="space-y-3 max-h-[304px] overflow-y-auto scrollbar-hide">
            <div className="rounded-xl p-5 flex justify-between items-center bg-white cursor-pointer hover:border-green-500 mb-5">
            ...
            <div className="rounded-xl p-5 flex justify-between items-center bg-white cursor-pointer hover:border-green-500 mb-0">
              <div className="flex"><input type="radio" name="plan" className="mr-3 h-5 w-5 accent-[#64748B] checked:accent-[#1A0F33]" />
                <span className="font-medium bg-[#F7F7F8] w-[98px] h-[26px]  rounded-2xl"></span></div>
              <span className="text-gray-500 text-sm bg-[#F7F7F8] w-[59px] h-[26px]  rounded-2xl"></span>
            </div>
        ...
        <div className="bg-[#F3F5F7] p-6 rounded-2xl shadow-sm">
          ...
          <h3 className="h4 mb-2">Install Your eSIM</h3>
          <p className="subtext mb-6">
            Get your QR code instantly by email. Scan it on your phone and your eSIM is ready to go.
          </p>

          <div className="flex bg-white rounded-xl flex-col items-center px-4 py-4 max-h-[304px] overflow-y-auto scrollbar-hide">
        ...
        <div className="bg-[#F3F5F7] p-6 rounded-2xl shadow-sm">
          ...
          <h3 className="h4 mb-2">Stay Connected Globally</h3>
          <p className="subtext mb-6">
          ...
          <div className="border-[#3BC852] border rounded-xl p-4 bg-[#F5FCF6] flex flex-col gap-2">
          ...
          <div className=" rounded-xl p-4 bg-[#fff] flex flex-col gap-2 mt-5">
            <div className="flex items-center justify-between">
