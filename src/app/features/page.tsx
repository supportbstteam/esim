...
//   return (
//     <div>
//          <MainBanner title="Smart Connectivity for Smarter Travel" subtitle="Experience fast, reliable, and affordable eSIM solutions designed for travelers who never want to disconnect." backgroundImage="/features.webp" />
...
const page = () => {
  return (
    <section className=" px-10 bg-white overflow-hidden">
      <div className="max-w-full mx-auto px-4 sm:px-6">
        <div className="prose-content max-w-none prose-slate prose-base sm:prose-lg md:prose-xl text-gray-800">
          <div className="container md:mb-20">
            <div className="about-layout">
              <div className="mx-auto pt-5 mb-10 md:mb-20 flex max-lg:flex-col justify-between">
                ...
                <div className="!text-[20px] subtext lg:max-w-lg leading-relaxed space-y-8">
                  ...
                  <p>
                    With our eSIM technology, you can forget about expensive roaming charges, SIM swaps, or hunting for local stores. Just activate your plan in minutes and explore the world with confidence.
                  </p>
                </div>
              </div>
            </div>
            <div className="mb-10 md:mb-20">
              <img className="w-full object-cover rounded-2xl md:max-h-[540px]" src="/_next/image?url=%2Fglobabou.jpg&amp;w=3840&amp;q=75" alt="" width="1248" height="540" />
            </div>
            <div className="about-layout mb-10 lg:mb-20">
              <div className="mx-auto gap-6 lg:gap-[57px] pb-12 flex flex-col items-start justify-between">
                ...
                <div className="flex max-lg:flex-col lg:gap-[25px]">
                  ...
                  <p className="!text-[20px] w-full lg:w-[35%] subtext">
                    We’re a global team of innovators, travelers, and tech enthusiasts passionate about making connectivity effortless.
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="rounded-xl border border-gray-200 p-6 bg-white shadow-sm hover:shadow-md transition">
                  ...
                  <h3 className="text-[#1A0F33] text-[20px] font-semibold mt-2">
                    Global Coverage
                  </h3>
                  <p className="mt-3 subtext text-sm leading-relaxed">
                    Connect in 200+ countries with one eSIM.
                  </p>
                </div>
                <div className="rounded-xl border border-gray-200 p-6 bg-white shadow-sm hover:shadow-md transition">
                  <p>
            ...
            <div className="flex mb-10 lg:mb-20 justify-between flex-col md:flex-row gap-8 md:gap-16 pb-16">
              <div className="flex flex-col lg:max-w-[50%]">
                <h3 className="text-[16px] font-semibold text-[#1A0F33] tracking-wide uppercase mb-12">
                  OUR JOURNEY
                </h3>
                <h1 className="h1 w-full lg:max-w-lg !leading-tight tracking-tight mb-9">
                  The Story Behind Our Global eSIM Revolution
                </h1>
                <p className="subtext !text-[20px] lg:max-w-[80%]">
                  Our story began with a simple idea: staying connected while traveling shouldn’t be complicated.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 mt-3 lg:mt-12">
                  <div className="border border-gray-300 rounded-lg p-6 flex-1">
                    ...
                    <h4 className="text-[#1A0F33] font-semibold text-lg mb-1">
                      200+ Countries
                    </h4>
                    <p className="subtext">
                      Empowering travelers across the globe with seamless eSIM connectivity.
                    </p>
                  </div>
                  <div className="border border-gray-300 rounded-lg p-6 flex-1">
                    <p>
                    ...
                    <h4 className="text-[#1A0F33] font-semibold text-lg mb-1">
                      1 Million+ eSIMs Activated
                    </h4>
                    <p className="subtext">
                      Trusted by global explorers who stay connected anytime, anywhere.
                    </p>
                  </div>
                </div>
              </div>
              <div className="flex justify-center items-center lg:max-w-[50%]">
                <img className="lg:w-[575px] object-cover rounded-[12px] lg:max-h-[528px]" src="/_next/image?url=%2Ffullshot_new.webp&amp;w=1200&amp;q=75" alt="Happy travelers" width="575" height="528" />
              </div>
            </div>
          </div>
        </div>
