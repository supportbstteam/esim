...
function Profile() {
    ...
    const handleUpdateUser = async (values: any) => {
        try {
            ...
            // console.log("---- update in the user details -----", response);
        }
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        catch (err: any) {
            console.error("Error in the user update", err);
        ...
        <div className="max-w-5xl mx-auto py-10 px-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div className="flex flex-col items-start sm:items-end gap-2">
                    ...
                    <button
                        onClick={() => setChangePasswordModal(true)} // optional modal trigger
                        className="text-sm text-red-500 font-weight:500 hover:underline"
                    >
                        Change Password
                    </button>
                </div>
            ...
            <EditProfileModal isOpen={editModal} onClose={() => setEditModal(false)} onSubmit={handleUpdateUser} />

            <ChangePasswordModal isOpen={changePasswordModal} onClose={() => setChangePasswordModal(false)} onSubmit={handleUpdateUser} />
